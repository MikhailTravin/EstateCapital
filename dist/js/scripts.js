document.addEventListener('DOMContentLoaded', function () {
  ...
  // RANGE SLIDERS
  function initRangeSlider(sliderId, minId, maxId, options) {
  ...
  initRangeSlider('priceRange', 'priceRangeFrom', 'priceRangeTo', {
    min: 15,
    max: 315
  });

  initRangeSlider('sizeRange', 'sizeRangeFrom', 'sizeRangeTo', {
    min: 7,
    max: 359
  });
  // END RANGE SLIDERS
  ...
  function initMaps() {
    ...
    if (document.getElementById('map2')) {
      ...
      var placemark2 = new ymaps.Placemark([55.7643235689689, 37.55611849999994], {
        hintContent: '123022 Звенигородское ш. 18/20, стр. 1'
      }, {
        iconLayout: 'default#image',
        iconImageHref: 'images/mark.svg',
...
const filterClose = document.querySelector('.filter-top__close');
